...
import { LogOut, Edit3, Award, BookOpen } from 'lucide-react';
        ...
        <CardContent className="p-6 space-y-10">
          ...
          <div>
            ...
            <div className="text-center text-muted-foreground p-8 border-2 border-dashed rounded-lg bg-secondary/30">
              ...
              <Button variant="link" className="mt-2 text-primary">Comece a compartilhar!</Button>
            </div>
          </div>
           ...
           <div>
            ...
            <div className="text-center text-muted-foreground p-8 border-2 border-dashed rounded-lg bg-secondary/30">
              <p>Envie receitas para ganhar pontos e títulos!</p>
            </div>
          </div>
        </CardContent>
      </Card>
