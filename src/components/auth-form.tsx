...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  const linkText = mode === 'login' ? 'Não tem uma conta? Cadastre-se' : 'Já tem uma conta? Faça login';
      ...
      <Form {...form}>
       ...
       <div className="mt-6 text-center">
        <p className="text-sm text-muted-foreground">
          {linkText}
          <Link href={linkHref} className="font-semibold text-primary hover:underline ml-1">
            aqui
          </Link>
        </p>
      </div>
